...
<section class="content-header">
  <h1>
    Grupos
    <small>Editando: {{ $group->name }}</small>
  </h1>
</section>
      ...
      <div class="box-content">
        <div class="container-fluid">
          <div class="row">
            ...
            @endif
            <div class="col-md-6">
              {{ Form::model($group, ['route' => ['groups.update', $group->id], 'method' => 'PUT', 'class' => 'form', 'class' => 'form form-horizontal']) }}
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <select class="form-control" name="employee_id">
                    ...
                    @if($supervisor->id == $group->supervisor->id)
