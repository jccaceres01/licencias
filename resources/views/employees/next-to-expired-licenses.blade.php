...
<section class="content-header">
  <h1>
    Empleados con licencias Proximas a expirar
    <small>Rango de fecha de 3 meses </small>
  </h1>
</section>
...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title"><i class="fa fa-users"></i> Proximas a expirar <span class="badge">{{ $nextToExpireCount }}</span></h3>
    ...
    <div class="box-body">
      <form class="form" action="{{ route('employees.licenses.soon.expire')}}" method="get">
