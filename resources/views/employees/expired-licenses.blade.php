...
<section class="content-header">
  <h1>
    Empleados con licencias expiradas
...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title"><i class="fa fa-users"></i> Empleados con licencias expiradas <span class="badge">{{ $expiredCount }}</span></h3>
    ...
    <div class="box-body">
      <form class="form" action="{{ route('employees.licenses.expired')}}" method="get">
