...
<section class="content-header">
  <h1>
    ...
    <small>Solo empleados cancelados </small>
  </h1>
</section>
...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title"><i class="fa fa-users"></i> Dados de baja <span class="badge">{{ $downCount }}</span></h3>
    ...
    <div class="box-body">
      <form class="form" action="{{ route('employees.down')}}" method="get">
            ...
            <td>
              ...
              <div class="dropdown inline">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="">
                  @can('edit employees')<li><a href="{{ route('employees.status.up', $employee->id)}}" onclick="return confirm('¿Desea reactivar el empleado?')" title="Cancelar empleado" data-toggle="tooltip" data-placement="top"><i class="fa fa-arrow-circle-down"></i> Reactivar </a></li>@endcan
                </ul>
              </div>
            </td>
          </tr>
