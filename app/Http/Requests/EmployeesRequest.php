...
class EmployeesRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
          ...
          'nickname' => 'max:45',
          'identify_document' => ['required', 'max:45', Rule::unique('employees')->ignore($this->id)],
          'address' => 'max:255',
    ...
    public function messages() {
      return [
        ...
        'identify_document.max' => 'El campo: Cedula, solo admite 45 caracteres',
        'identify_document.required' => 'El campo: Cedula, es necesario',
        'identify_document.unique' => 'El campo: Cedula, debe de ser unico, ya existe un registro similar',
